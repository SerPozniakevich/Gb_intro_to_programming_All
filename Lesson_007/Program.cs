...
// //Создание двумерного массива заполненного вещественными числами.
// int line = 3;
// int column = 4;
...
//     {
//         a[i, j] = new Random().NextDouble() *20-10; // NextDouble() дает случайное вещественное число в диапазоне от 0 до 10
//         Console.Write("{0,5:F1}", a[i, j]); // 0,5  - отступ, F1 - кол-во знаков после запятой
//     }
//     Console.WriteLine();
// }
